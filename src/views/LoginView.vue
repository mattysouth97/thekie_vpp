...
import { IcoArrowLeft, IcoBuilding, IcoDocument, IcoMail, IcoLock, IcoEye, IcoEyeOff, IcoInfo, IcoArrowRight, IcoGithub, IcoCoin } from "@/components/icons";
  ...
  <div class="login-page">
    ...
    <div class="login-left">
      ...
      <div class="login-left__content">
        ...
        <div class="login-left__tagline">VPP 전력 정산 플랫폼</div>
    ...
    <div class="login-right">
      <div class="login-form-wrap">
        ...
        <div class="login-form__head">
          <h1 class="login-form__title">{{ isBusiness ? '법인 계정 로그인' : '다시 오신 것을 환영합니다' }}</h1>
          <p class="login-form__sub">{{ isBusiness ? '사업자 정보로 로그인하세요' : '에너지 통장에 로그인하세요' }}</p>
        </div>

...
.node-card.selected {
  border-color: #f97316;
  box-shadow: 0 0 0 2px rgba(249,115,22,0.25), 0 4px 16px rgba(0,0,0,0.1);
}
...
.body {
  ...
  background: repeating-linear-gradient(
    to right,
    #f0ede8 0px, #f0ede8 8px,
    #e4e0da 8px, #e4e0da 11px
  );
}
...
.fname {
  flex: 1; font-size: 9px; font-weight: 700; color: #431407;
  white-space: nowrap; overflow: hidden; text-overflow: ellipsis;
}
.fval { font-size: 9px; font-weight: 700; color: #f97316; white-space: nowrap; }
</style>
